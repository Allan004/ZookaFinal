...
<?php else: ?>
            ...
            <div class="continue-shopping-wrapper" style="width: 100%; text-align: center; margin: 24px 0;">
                <a href="produtos.php" class="continue-shopping-btn" style="display: inline-block; padding: 14px 24px; background: #2eaeb0; color: #fff; border-radius: 8px; text-decoration: none; font-weight: 600;">Continuar comprando</a>
            </div>
