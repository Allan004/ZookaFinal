    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <form method="post">
                ...
                <div class="field">
                    <label>Nome</label>
                    <input type="text" name="nome" value="<?= htmlspecialchars($_POST['nome'] ?? ($servico_editar['nome'] ?? '')) ?>" required>
                </div>

                <div class="field">
                    <label>Descrição</label>
                    <input type="text" name="descricao" value="<?= htmlspecialchars($_POST['descricao'] ?? ($servico_editar['descricao'] ?? '')) ?>" required>
                </div>

                <div class="field">
                    <label>Preço</label>
                    <input type="text" name="preco" value="<?= htmlspecialchars($_POST['preco'] ?? ($servico_editar['preco'] ?? '')) ?>" required>
                </div>
